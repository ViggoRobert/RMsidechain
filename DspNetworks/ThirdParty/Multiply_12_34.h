...
template <int NV> struct Multiply_12_34: public data::base
{
	// Metadata Definitions ------------------------------------------------------------------------
	
	SNEX_NODE(Multiply_12_34);
	
	struct MetadataClass
	{
		SN_NODE_ID("Multiply_12_34");
	};
	...
	static constexpr int getFixChannelAmount() { return 4; };
